...
df_references
df_references[df_references['username']==st.session_state.login["name"]]['allow'].values
st.sidebar.page_link("http://www.google.com", label="Page 2", icon="2️⃣", disabled=False)
